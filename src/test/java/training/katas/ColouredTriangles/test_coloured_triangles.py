...
import pytest
from src.main.java.training.katas.ColouredTriangles.coloured_triangles import (
    get_color,
    triangle,
)
...
@pytest.mark.parametrize("color1,color2,expected_result", test_data_single_color)
