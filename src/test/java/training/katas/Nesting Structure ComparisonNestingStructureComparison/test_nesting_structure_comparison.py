from src.main.java.training.katas.NestingStructureComparison.\
    nesting_structure_comparison import same_structure_as
...
def test_nesting_structure_comparison(original: List[int],
                                      other: List[int], expected_result: bool):
