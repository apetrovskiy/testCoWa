...
from src.main.java.training.katas.PickPeaks.pick_peaks import pick_peaks
...
test_data = [
    ...
    ([1, 2, 5, 4, 3, 2, 3, 6, 4, 1, 2, 3, 3, 4, 5, 3, 2, 1, 2, 3,
      5, 5, 4, 3], {"pos": [2, 7, 14, 20], "peaks":[5, 6, 5, 5]}),
    ([], {"pos": [], "peaks":[]}),
    ([1, 1, 1, 1], {"pos": [], "peaks":[]})
]
...
Test.assert_equals(pick_peaks([1,2,5,4,3,2,3,6,4,1,2,3,3,4,
5,3,2,1,2,3,5,5,4,3]), {"pos":[2,7,14,20], "peaks":[5,6,5,5]})
